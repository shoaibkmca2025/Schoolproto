    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white p-12 rounded-xl shadow-lg border border-slate-200 min-h-[1000px] print:shadow-none print:border-none print:rounded-none" ref={componentRef}>
        ...
        <div className="flex justify-between items-start mb-12">
          ...
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 text-right min-w-[200px]">
        ...
        <div className="space-y-6 mb-12">
          ...
          <div className="bg-slate-50 p-8 rounded-xl grid grid-cols-2 gap-y-6 gap-x-12">
        ...
        <div className="flex justify-between items-start gap-12 mb-12">
          ...
          <div className="w-[300px] space-y-4">
            ...
            <div className="bg-blue-600 p-6 rounded-xl text-white flex justify-between items-center">
